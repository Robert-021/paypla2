            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                ...
                <div className="flex flex-col space-y-6">
                    ...
                    <div className="flex gap-4">
                        <a href="https://www.facebook.com/homeplaytodoatualcanse/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-white hover:bg-[rgb(217,61,47)] hover:border-[rgb(217,61,47)] transition-all duration-300 group shadow-lg">
                        ...
                        <a href="https://www.instagram.com/payplay.23?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-white hover:bg-[rgb(217,61,47)] hover:border-[rgb(217,61,47)] transition-all duration-300 group shadow-lg">
                            <svg className="w-6 h-6 transition-transform" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <a href="https://www.tiktok.com/@payplay.ec?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-white hover:bg-[rgb(217,61,47)] hover:border-[rgb(217,61,47)] transition-all duration-300 group shadow-lg">
