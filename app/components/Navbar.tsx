        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <Link href="/" className="logo flex items-center gap-2 group">
                    <div className="w-10 h-10 bg-[rgb(217,61,47)] rounded-xl flex items-center justify-center shadow-lg shadow-red-900/20 group-hover:scale-110 transition-transform duration-300">
