    ...
    return (
        <div className="min-h-screen" style={{ fontFamily: "'Georgia', serif" }}>
            ...
            <section className="bg-zinc-900 text-white py-12 px-6">
                <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/10 rounded-2xl overflow-hidden">
                    {[
                        ...
                        <div key={i} className="bg-zinc-900 px-8 py-8 flex flex-col items-center text-center">
                            <span className="text-5xl font-black italic text-[rgb(217,61,47)] mb-1">{s.value}</span>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col gap-4">
                        {indicators.map((item, i) => (
                            ...
                            >
                                {/* Number */}
                                <span className="text-3xl font-black italic text-zinc-200 group-hover:text-[rgb(217,61,47)] transition-colors duration-300 text-right">
                                    {item.num}
                                </span>
                                {/* Divider */}
                                ...
                                <div className="flex items-start gap-5">
                                    ...
                                    <div>
                                        <h3 className="font-black italic uppercase tracking-tight text-zinc-900 text-base mb-1">
                                            {item.title}
                                        </h3>
            ...
            <section className="bg-[rgb(217,61,47)] text-white py-20 px-6 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
                        <div>
                            <h2 className="text-4xl sm:text-5xl font-black italic uppercase tracking-tighter text-zinc-900 leading-tight mb-6">
                                Decisiones de<br />
                        ...
                        <div className="flex flex-col gap-4">
                            {outcomes.map((o, i) => (
                                <div key={i} className="flex items-center gap-5 bg-zinc-900/20 border border-white/20 rounded-2xl px-6 py-5 backdrop-blur-sm">
                                    ...
                                    <div>
                                        <span className="font-black italic uppercase text-white text-sm block">{o.label}</span>
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                        ...
                        <div className="mt-6 pt-6 border-t border-white/10 flex items-center justify-between">
                            ...
                            <span className="text-green-400 font-black italic uppercase text-sm">Riesgo Bajo — Aprobar</span>
                        </div>
                    </div>
                </div>
            </section>
